...
set output 'write_bw-steady_state_convergence_1280.png'
...
set xtics 1
set ytics 5
set title "Write bandwidth Steady State Convergence Plot - 1024KiB block size"
set xlabel 'Round'
set ylabel 'Bandwidth (MiB/s)'
set xrange [1:10]
set yrange [0:]
plot 'test02_data_write_1m.csv' using 1:($2/1024) title 'Write 1024KiB' with lp
exit
